                ...
                <div v-for="record in filteredRecords" :key="record.id"
                    ...
                    <div class="p-4 flex items-center gap-3">
                        ...
                        <input
                            ...
                            ref="titleInputs"
                            class="flex-1 border-none p-0 font-bold text-gray-700 dark:text-white focus:ring-0 bg-transparent placeholder:text-gray-300"
                    ...
                    <div v-show="expandedRecords.has(record.id)" class="px-4 pb-4">
                        ...
                        <textarea v-model="record.notes" @input="saveRecord(record)"
                                  class="w-full bg-[#F8F9FF] dark:bg-gray-900 border border-blue-100 dark:border-gray-700 rounded-xl p-3 text-sm text-gray-600 dark:text-gray-300 focus:ring-1 focus:ring-blue-400 min-h-[150px] placeholder:text-gray-300"
